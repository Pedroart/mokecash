<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="tienda_id" class="form-control @error('tienda_id') is-invalid @enderror" value="{{ old('tienda_id', $producto?->tienda_id) }}" id="tienda_id" placeholder="Tienda Id">
